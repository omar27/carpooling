...
import { FavLocationComponent } from 'app/entities/fav-location/fav-location.component';
...
describe('Component Tests', () => {
  describe('FavLocation Management Component', () => {
    let comp: FavLocationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FavLocationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.favLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
